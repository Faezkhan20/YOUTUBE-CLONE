  ...
  return (
    ...
    <div id='youtubeloginmain'>
      ...
      <div className='signupinputdiv'>
        <input className='signupinputfocus' type="text" placeholder='' name='name' onChange={handleChange} />
        <label className='signuplabel'>Name</label>
      </div>
      <div className='signupinputdiv'>
        <input className='signupinputfocus' type="text" placeholder='' name='email' onChange={handleChange} />
        <label className='signuplabel'>Email</label>
      </div>
      <div className='signupinputdiv'>
        <input className='signupinputfocus' type="text" placeholder='' name='password' onChange={handleChange} />
